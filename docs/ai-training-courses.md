...
|---|---|---|---|---|---|---|---|---|
|   |   |   |   |   |   |   |   |   |
| 2024 | Deep Neural Networks | [Notebooks](https://github.com/stfc-sciml/sciml-workshop/tree/master/course_3.0/DNN) | Hybrid | STFC SciML Team | 2.5 hrs | CEDA Staff (09/07/2024) | Intro to Neural Networks and there features and capabilities; included some hands-on Jupyter Notebooks for trying these approaches for ourseleves | Useful introduction - can review and work on materials ourselves |
